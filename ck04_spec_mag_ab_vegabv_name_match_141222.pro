pro ck04_spec_mag_ab_vegabv_name_match_141222
close,/all
...
inputfile_vega=filepath('ck04_model_mag_vegabv.dat',$
root_dir='/home/han/WORK/LUT/LUT_mag_calibration/LUT_mag_calibration_141222/lut_optical_efficiency_curve/')
...
;with CCD sensitivity curve
outputfile=filepath('mag4lot_tyc_bv_ccd.dat',$
root_dir='/home/han/WORK/LUT/LUT_mag_calibration/LUT_mag_calibration_141222/lut_optical_efficiency_curve/')
...
message,'Argument FILE is underfined'
record={filename:'',flux_den_lam_b:0.0D,magvega_b:0.0d,flux_den_lam_v:0.0D,magvega_v:0.0d,zero_gap_bv:0.0d}
...
data1[j].flux_den_lam_v = word1[3]
data1[j].magvega_v = word1[4]
data1[j].zero_gap_bv = word1[5]
endfor
close,60
...
record3={filename:'',type:'',tem:0L,magab:0.0d,magvega_b:0.0d,magvega_v:0.0d,magvega_bv:0.0d,mag_minus:0.0d,magab_30:0.0d,magvega_30:0.0d,redleak_persent:0.0d}
...
data3[l].magvega_v = data1[m].magvega_v
data3[l].magvega_bv = data1[m].magvega_b - data1[m].magvega_v ; + data1[m].zero_gap_bv
data3[l].mag_minus = data3[l].magab - data3[l].magvega_v
