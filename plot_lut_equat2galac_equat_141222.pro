pro plot_lut_equat2galac_equat_130909
close,/all
...
outputfile=filepath('plot_lut_equat2galac_equat',$
root_dir='E:\WORK\LUT\LUT_mag_calibration\LUT_mag_calibration_130909\lut_optical_efficiency_curve\')
print,'Start working'
...
xyouts,180,40,label1,charsize=csize-0.5,color=0,charthick=cthick+1
label1 = (strtrim(strtrim(string(format='(f5.2)',n/(m+n))),1))
xyouts,310,40,label1,charsize=csize-0.5,color=0,charthick=cthick+1
xyouts,5,-5,'0',charsize=csize,color=0,charthick=cthick
xyouts,190,-5,'180',charsize=csize,color=0,charthick=cthick
