pro plot_color_vs_col_index_new_effi_curve_1141222
close,/all
...
;with CCD sensitivity curve
outputfile=filepath('mag4lot_AB_br_ccd',$
root_dir='/home/han/WORK/LUT/LUT_mag_calibration/LUT_mag_calibration_141222/lut_optical_efficiency_curve/')
entry_device=!d.name
!p.multi=[1,1,1]
set_plot,'ps'
...
;record={filename:'',type:'',tem:0L,magab:0.0d,magvega_b:0.0d,magvega_v:0.0d,magvega_bv:0.0d,mag_minus:0.0d,magab_05:0.0d,magvega_05:0.0d}
record={magab:0.0d,magvega_b:0.0d,magvega_r:0.0d,magvega_br:0.0d,mag_minus:0.0d,magab_05:0.0d,magvega_05:0.0d,redleak_persent:0.0d}
...
data[i].magvega_br = word[3]
data[i].mag_minus = word[4]
data[i].redleak_persent = word[7]
print,data[i].magvega_br, data[i].mag_minus,data[i].redleak_persent
endfor
close,50
...
xtitle='B-R',$
XCHARSIZE=1.5,$
ytitle='LOT mag(AB) - R mag',YCHARSIZE=1.5, $
