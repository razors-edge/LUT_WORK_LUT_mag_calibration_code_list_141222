pro plot_color_vs_col_index_red_leak_new_effi_curve_130909
close,/all
...
;with CCD sensitivity curve
outputfile=filepath('mag4lot_AB_bv_redleak_ccd',$
root_dir='E:\WORK\LUT\LUT_mag_calibration\LUT_mag_calibration_130909\lut_optical_efficiency_curve\')
entry_device=!d.name
!p.multi=[1,1,1]
set_plot,'ps'
...
xyouts,-0.3,4.2,'red leak from 3340 A',charsize=csize,color=1,charthick=cthick 
