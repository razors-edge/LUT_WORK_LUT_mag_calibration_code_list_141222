pro br_color_fit_new_effi_curve_141222
close,/all
...
;with CCD sensitivity curve
outputfile=filepath('br_color_abs_fit_ccd',$
root_dir='/home/han/WORK/LUT/LUT_mag_calibration/LUT_mag_calibration_141222/lut_optical_efficiency_curve/')
...
close,60
record={magab:0.0d,magvega_b:0.0d,magvega_r:0.0d,magvega_br:0.0d,mag_minus:0.0d,magab_30:0.0d,magvega_30:0.0d,redleak_persent:0.0d}
...
;PLOTSYM,8,1,/FILL
plot,data.magvega_br,data.mag_minus ,$
...
record1={magvega_br:0.0d,mag_minus:0.0d}
data1=replicate(record1,maxrec+3)
for m=0 , maxrec-2 do begin
data1[m].magvega_br = data[m].magvega_br
...
;with CCD sensitivity curve
data1[maxrec-1].magvega_br = 3.94
data1[maxrec-1].mag_minus = 5.4
data1[maxrec].magvega_br = 4.1
data1[maxrec].mag_minus = 5.5
data1[maxrec+1].magvega_br = 4.34
data1[maxrec+1].mag_minus = 5.55
data1[maxrec+2].magvega_br = 4.54
data1[maxrec+2].mag_minus = 5.6


result=poly_fit(data.magvega_br, data.mag_minus, 3, measure_error= measure_errors, $
sigma=sigma)

print, 'Coeffiencts:', result
print, 'Standard errors:', sigma

x2=( FindGen(500) * 0.01 ) - 4.0
y2=result[0] + result[1] * ( x2 ) + result[2] * ( x2 ^2 ) + result[3] * (x2^3) 
; + result[4] * (x2^4)
oplot,x2,y2,linestyle=1,color=0,thick=5

;oplot,[data1[maxrec-1].magvega_br,data1[maxrec-1].magvega_br],[data1[maxrec-1].mag_minus,data1[maxrec-1].mag_minus],psym=1,thick=3,color=1
;oplot,[data1[maxrec].magvega_br,data1[maxrec].magvega_br],[data1[maxrec].mag_minus,data1[maxrec].mag_minus],psym=1,thick=3,color=1
;oplot,[data1[maxrec+1].magvega_br,data1[maxrec+1].magvega_br],[data1[maxrec+1].mag_minus,data1[maxrec+1].mag_minus],psym=1,thick=3,color=1
;oplot,[data1[maxrec+2].magvega_br,data1[maxrec+2].magvega_br],[data1[maxrec+2].mag_minus,data1[maxrec+2].mag_minus],psym=1,thick=3,color=1
